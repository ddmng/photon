...
public class Server {
    ...
    private void setupDirectories(URL directoryName) throws IOException, URISyntaxException {
        ...
        Files.copy(loader.getResourceAsStream("modules/lang-painless/lang-painless-6.1.2.jar"),
                new File(painlessDirectory, "lang-painless-6.1.0.jar").toPath(), StandardCopyOption.REPLACE_EXISTING);
    ...
    public void recreateIndex() throws IOException {
        ...
        System.out.println("========== "+ index_settings);
